...
// Same as OpenEhrRestClientTest but with Prefer:return=minimal header
class OpenEhrRestClientMinimalTest extends Specification {
   ...
   */
   ...
   def "A.a. get ehr"()
   {
      ...
      then:
         ...
         def retrievedEhr = client.getEhr(createdEhrId) // FIXME: should read the etag from the response because there is no body
         retrievedEhr != null
